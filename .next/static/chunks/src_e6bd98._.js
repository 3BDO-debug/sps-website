(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_e6bd98._.js", {
...
function page() {
    ...
    const [relatedProjects, setRelatedProjects] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const fetchProjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "page.useCallback[fetchProjects]": async ()=>{
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$_$5f$apis_$5f2f$projects$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsFetcher"])(id).then({
                "page.useCallback[fetchProjects]": (response)=>{
                    setProjectData(response[0]);
                }
            }["page.useCallback[fetchProjects]"]).catch({
                "page.useCallback[fetchProjects]": (error)=>{
                    triggerAlert({
                        triggered: true,
                        type: "error",
            ...
            }["page.useCallback[fetchProjects]"]);
        }
    }["page.useCallback[fetchProjects]"], [
        id
    ]);
    ...
    const fetchRelatedProjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "page.useCallback[fetchRelatedProjects]": async ()=>{
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$_$5f$apis_$5f2f$projects$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsFetcher"])(null, null, projectData.category).then({
                "page.useCallback[fetchRelatedProjects]": (response)=>{
                    const randomIndex = Math.floor(Math.random() * response.length);
                    setRelatedProjects(response[randomIndex]);
                }
            }["page.useCallback[fetchRelatedProjects]"]).catch({
                "page.useCallback[fetchRelatedProjects]": (error)=>{}
            }["page.useCallback[fetchRelatedProjects]"]);
        }
    }["page.useCallback[fetchRelatedProjects]"], [
        id
    ]);
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                            children: [
                                                ...
                                                projectData.description && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                                    ...
                                                    children: projectData.description.split("•").filter((point)=>point.trim() !== "").map((point, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                "• ",
                                                                point.trim()
                                                            ]
...
_s(page, "DBan70MpIzuQ80Go2auyJ3/Hjdg=", false, function() {
    return [
...
//# sourceMappingURL=src_e6bd98._.js.map